...
func TestConfirmPayment_Success(t *testing.T) {
	...
	status, message, data := utils.ConfirmationPay(transactionRequest.InternalID.String(), "true")
...
func TestConfirmPayment_Failed(t *testing.T) {
	...
	status, message, data := utils.ConfirmationPay(transactionRequest.InternalID.String(), "false")
